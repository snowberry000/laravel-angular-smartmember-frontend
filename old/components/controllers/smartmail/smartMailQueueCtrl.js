app.controller('SmartMailQueueController', function ($scope, $localStorage, $location, $state, Restangular, $modal, toastr, $site) {
    $scope.template_data = {
    ...
    $scope.editJob = function(job) {
        $state.go('admin.team.email.sendmail', {'job' : job});
    }
