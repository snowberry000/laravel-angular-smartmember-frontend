app.controller('HelpdeskParentController', function ($scope, $rootScope , $localStorage,$state, $modal, Restangular, notify) {
...
app.controller('openTicketsController', function ($scope ,$location, $localStorage,$rootScope, $state, $user, $modal, Restangular, notify,$site) 
{
...
app.controller('pendingTicketsController', function ($scope ,$location, $localStorage,$rootScope, $state, $user, $modal, Restangular, notify,$site) 
{
    $scope.tickets=[];
    $scope.sites =[];
    $scope.ticket_users=[];
...
app.controller('solvedTicketsController', function ($scope ,$location, $localStorage,$rootScope, $state, $user, $modal, Restangular, notify,$site) 
{
    $scope.tickets=[];
    $scope.sites =[];
    $scope.ticket_users=[];
...
app.controller('spamTicketsController', function ($scope ,$location, $localStorage,$rootScope, $state, $user, $modal, Restangular, notify,$site) 
{
    $scope.tickets=[];
    $scope.sites =[];
    $scope.ticket_users=[];
