...
{
	$stateProvider
		.state( "public.admin.team.jv.affiliates", {
			url: "/affiliates",
			templateUrl: "/templates/components/public/admin/team/jv/affiliates/affiliates.html",
...
app.controller( "AffiliatesController", function( $scope, $rootScope, $localStorage, Restangular )
{
	...
	$scope.template_data = {
		...
		singular: 'affiliate',
		edit_route: 'public.admin.team.jv.affiliate',
