...
app.config(function($stateProvider){
	$stateProvider
		.state("public.admin.team.helpdesk.agent-stats.agent-stat",{
			url: "/:id?",
			templateUrl: "/templates/components/public/admin/team/helpdesk/agent-stats/agent-stat/agent-stat.html",
