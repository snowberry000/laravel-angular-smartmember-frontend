...
app.config(function($stateProvider){
	$stateProvider
		.state("public.admin.site.content.livecasts",{
			url: "/livecasts",
			templateUrl: "/templates/components/public/admin/site/content/livecasts/livecasts.html",
			controller: "LivecastsController"
		})
}); 

app.controller("LivecastsController", function ($scope,$rootScope,$http,Restangular) {
	$scope.template_data = {
        title: 'LIVECASTS',
        description: 'Embed live hangout & webinar code or display past recordings',
        singular: 'livecast',
        edit_route: 'public.admin.site.content.livecast',
        api_object: 'livecast'
    }
