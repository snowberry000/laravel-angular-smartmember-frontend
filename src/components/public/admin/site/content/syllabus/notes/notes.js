...
app.config(function($stateProvider){
	$stateProvider
		.state("public.admin.site.content.syllabus.notes",{
			url: "/notes",
			templateUrl: "/templates/components/public/admin/site/content/syllabus/notes/notes.html",
...
app.controller('NotesController', function ($scope, $site, $rootScope, $localStorage, Restangular , $modal) {
    ...
    $scope.template_data = {
        ...
        singular: 'note',
        edit_route: 'public.admin.site.content.syllabus.note',
        api_object: 'userNote'
    }
