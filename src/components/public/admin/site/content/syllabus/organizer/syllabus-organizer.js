...
app.config(function($stateProvider){
	$stateProvider
		.state("public.admin.site.content.syllabus.organizer",{
			url: "/organizer",
			templateUrl: "/templates/components/public/admin/site/content/syllabus/organizer/syllabus-organizer.html",
