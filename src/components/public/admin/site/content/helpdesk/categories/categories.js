...
app.config(function($stateProvider){
	$stateProvider
		.state("public.admin.site.content.helpdesk.categories",{
			url: "/categories",
			templateUrl: "/templates/components/public/admin/site/content/helpdesk/categories/categories.html",
...
app.controller("CategoriesController", function ($scope,$rootScope,$site, $modal,$localStorage, $state, $stateParams,$filter, Restangular, toastr) {
    ...
    $scope.template_data = {
        ...
        edit_route: 'public.admin.site.content.helpdesk.category',
