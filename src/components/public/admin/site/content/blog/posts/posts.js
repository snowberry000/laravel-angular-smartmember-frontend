...
{
	$stateProvider
		.state( "public.admin.site.content.blog.posts", {
			url: "/posts",
			templateUrl: "/templates/components/public/admin/site/content/blog/posts/posts.html",
...
app.controller( "PostsController", function( $scope, $rootScope, $localStorage, $state, $stateParams,  $filter, Restangular, toastr )
{
	$scope.template_data = {
		...
		singular: 'post',
		edit_route: 'public.admin.site.content.blog.post',
		api_object: 'post'
	}
