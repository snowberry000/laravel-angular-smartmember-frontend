...
app.config(function($stateProvider){
	$stateProvider
		.state("public.admin.site.pages.core.refund",{
			url: "/refund",
			templateUrl: "/templates/components/public/admin/site/pages/core/refund/refund.html",
...
app.controller("RefundController", function ($scope, $localStorage, $site, $state, $stateParams, $modal, $filter, Restangular, toastr, Upload) {
	$scope.refund = {};
    $scope.loading=true;
