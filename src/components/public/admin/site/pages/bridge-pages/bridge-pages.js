...
app.config(function($stateProvider){
	$stateProvider
		.state("public.admin.site.pages.bridge-pages",{
			url: "/bridge-pages",
			templateUrl: "/templates/components/public/admin/site/pages/bridge-pages/bridge-pages.html",
...
app.controller("BridgePagesController", function ($scope, $localStorage, $site, $state, $stateParams, $modal, $filter, Restangular, toastr) {
	$scope.template_data = {
        ...
        edit_route: 'public.admin.site.pages.bridge-page',
