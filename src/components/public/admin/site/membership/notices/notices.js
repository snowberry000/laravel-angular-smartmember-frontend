...
app.config(function($stateProvider){
	$stateProvider
		.state("public.admin.site.membership.notices",{
			url: "/notices",
			templateUrl: "/templates/components/public/admin/site/membership/notices/notices.html",
...
app.controller("NoticesController", function ($scope,$state, $rootScope, $localStorage, $site , $modal, Restangular, toastr) {
	$scope.template_data = {
	    ...
	    edit_route: 'public.admin.site.membership.notice',
