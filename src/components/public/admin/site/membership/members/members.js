...
{
	$stateProvider
		.state( "public.admin.site.membership.members", {
			url: "/members",
			templateUrl: "/templates/components/public/admin/site/membership/members/members.html",
			controller: "MembersController"
		} )
} );

app.controller( 'MembersController', function( $scope, $localStorage, $site, $rootScope, $location, $stateParams, Restangular, toastr, $state )
{
