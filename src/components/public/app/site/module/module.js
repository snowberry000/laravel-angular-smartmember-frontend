...
app.controller( 'PublicModuleController', function( $scope, smModal, $rootScope, $localStorage, $state, $stateParams, $filter, Restangular, toastr, $location )
{
    ...
    Restangular.all('').get('module/' + $stateParams.id + '?view=public').then( function( response )
    {
        $scope.loading = false;
        $modules = response;
