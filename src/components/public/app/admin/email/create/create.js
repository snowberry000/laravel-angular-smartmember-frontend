...
app.config(function($stateProvider){
	$stateProvider
		.state("public.app.admin.email.create",{
			url: "/create/:id?",
			templateUrl: "/templates/components/public/app/admin/email/create/create.html",
        ...
        .state("public.app.admin.email.segmentIntro",{
            url: "/create/:id?",
            templateUrl: "/templates/components/public/app/admin/email/create/segmentIntro.html",
    ...
    $scope.update = function(){
        ...
        $scope.email.put().then(function(response){
            ...
            if( $scope.email.action && $scope.email.action == 3 ) {
                ...
                $state.go('public.app.admin.email.queue');
            }
        })
    }
