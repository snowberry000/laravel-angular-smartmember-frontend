...
{
	$stateProvider
		.state( "public.app.admin.email.subscribers", {
			url: "/subscribers",
			templateUrl: "/templates/components/public/app/admin/email/subscribers/subscribers.html",
...
app.controller( "EmailSubscribersController", function( $scope, $rootScope ,$localStorage, Restangular, toastr, $state )
{
	...
	$scope.template_data = {
		...
		singular: 'subscriber',
		edit_route: 'public.app.admin.email.subscriber',
