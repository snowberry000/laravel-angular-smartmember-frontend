...
app.config(function($stateProvider){
	$stateProvider
		.state("public.administrate.team.email.autoresponders",{
			url: "/autoresponders",
			templateUrl: "/templates/components/public/administrate/team/email/autoresponders/autoresponders.html",
...
app.controller("AutorespondersController", function ($scope,smModal,$filter, $localStorage,  Restangular, notify) {
	...
	$scope.template_data = {
	    ...
	    edit_route: 'public.administrate.team.email.autoresponder',
