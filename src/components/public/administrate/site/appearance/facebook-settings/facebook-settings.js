...
app.config(function($stateProvider){
	$stateProvider
		.state("public.administrate.site.appearance.facebook-settings",{
			url: "/facebook-settings",
			templateUrl: "/templates/components/public/administrate/site/appearance/facebook-settings/facebook-settings.html",
