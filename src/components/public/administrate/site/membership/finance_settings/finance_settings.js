...
{
	$stateProvider
		.state( "public.administrate.site.membership.finance_settings", {
			url: "/finance_settings",
			templateUrl: "/templates/components/public/administrate/site/membership/finance_settings/finance_settings.html",
