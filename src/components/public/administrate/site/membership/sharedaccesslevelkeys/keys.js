...
{
	$stateProvider
		.state( "public.administrate.site.membership.sharedaccesslevelkeys", {
			url: "/sharekeys",
			templateUrl: "/templates/components/public/administrate/site/membership/sharedaccesslevelkeys/keys.html",
...
app.controller( "ShareAccessLevelKeysController", function( $scope, $localStorage, smModal, $rootScope, Restangular, toastr )
{
	...
	$scope.template_data = {
		...
		singular: 'key',
		edit_route: 'public.administrate.site.membership.sharedaccesslevelkey',
