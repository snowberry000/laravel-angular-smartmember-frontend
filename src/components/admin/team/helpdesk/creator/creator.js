...
app.config(function($stateProvider){
	$stateProvider
		.state("admin.team.helpdesk.creator",{
			url: "/creator",
			templateUrl: "/templates/components/admin/team/helpdesk/creator/creator.html",
...
app.controller("TicketCreatorController", function ($scope, $localStorage,$rootScope, $state, Restangular, toastr) {
