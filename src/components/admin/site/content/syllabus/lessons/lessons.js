...
app.config(function($stateProvider){
	$stateProvider
		.state("admin.site.content.syllabus.lessons",{
			url: "/lessons",
			templateUrl: "/templates/components/admin/site/content/syllabus/lessons/lessons.html",
			controller: "AdminLessonsController"
		})
}); 

app.controller("AdminLessonsController", function ($scope, $rootScope,$localStorage, $site , $state, $stateParams,$modal, $filter, Restangular, toastr) {
	$site=$rootScope.site;
    $scope.template_data = {
        title: 'LESSONS',
